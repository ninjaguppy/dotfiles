...
#+end_src
*** Capture
=doct= allows fixes the syntac of capture templates
#+begin_src elisp
(use-package! doct
  :commands doct)
#+end_src

This brick of code contains the capture templates.
...
Now we make the capture actions look nice
#+name: prettify-capture
#+begin_src elisp :noweb-ref none
...
We want to be able to capture things from anywhere!
#+begin_src elisp
...
#+end_src
Not sure what this does but like maybe itll make it look nice
#+begin_src elisp
...
#+begin_src elisp
    ...
    ;(add-to-list 'TeX-view-program-selection
                 ;'(output-pdf "sioyek"))
#+end_src
And it woud be cool to get synctex up and running
#+begin_src elisp
