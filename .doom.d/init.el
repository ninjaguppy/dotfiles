...
(doom! :input
       ...
       (latex +fold +pdf-tools +latexmk +cdlatex)   ; writing papers in Emacs has never been so fun
       ...
       (org +roam2 +pretty +journal +noter)               ; organize your plain life in plain text
